...
> Read [LLM-DISCLAIMER](docs/LLM-DISCLAIMER.md) first - this repository is tended by an
> autonomous loop, and that file says what the loop may do here, what it may not, and
> what to check before trusting anything in this tree.
